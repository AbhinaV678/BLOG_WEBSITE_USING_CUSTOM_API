...
app.patch("/posts/:id",(req,res)=>{
  ...
  const updatedPost = {
    id : posts[requiredPostIndex].id,
    title : req.body.title || posts[requiredPostIndex].title,
    content : req.body.content || posts[requiredPostIndex].content ,
    author :  req.body.author || posts[requiredPostIndex].author ,
    date : posts[requiredPostIndex].date
  }
...
app.delete("/posts/:id",(req,res)=>{
  ...
  if(requiredPostIndex===-1){
    ...
    posts.splice(requiredPostIndex,1);
